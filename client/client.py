...
def loop():                       #GUI
    ...
    while True:
        ...
        can_scan.place(x=480,y=400) #Place the canvas
        ...
        def code_receive():     #A function for data receiving
            ...
            while True:
                ...
                if not code_car:
                    ...
                    can_scan_1.place(x=500,y=400) #Place the canvas
        ...
        s1.place(x=300,y=150)                            #Define a Scale and put it in position
        ...
        l_ip.place(x=30,y=170)                           #Define a Label and put it in position
        ...
        l_ip_4.place(x=775,y=110)                         #Define a Label and put it in position

        l_ip_5=tk.Label(root,width=18,text='Use default IP',fg=color_text,bg=color_btn)
        l_ip_5.place(x=775,y=75)                         #Define a Label and put it in position
        ...
        fg='#212121',bg='#90a4ae')
        l_inter.place(x=300,y=250)                       #Define a Label and put it in position

        E1 = tk.Entry(root,show=None,width=16,bg="#ffffff",fg='#eceff1')
        E1.place(x=375,y=100)                             #Define a Entry and put it in position

        l_ip_3=tk.Label(root,width=10,text='IP Address:',fg=color_text,bg=color_bg)
        l_ip_3.place(x=380,y=75)                         #Define a Label and put it in position
        ...
        Btn0.place(x=100,y=275)
        Btn1.place(x=100,y=300)
        Btn2.place(x=30,y=300)
        Btn3.place(x=170,y=300)
        Btn4.place(x=170,y=325)
        Btn5.place(x=30,y=325)
        
        Btn6.place(x=765,y=300)
        Btn7.place(x=905,y=300)
        Btn8.place(x=835,y=325)
        Btn9.place(x=835,y=275)
        Btn10.place(x=835,y=300)
        Btn11.place(x=875,y=10)

        Btn12.place(x=710,y=185)
        Btn13.place(x=375,y=440)


        # Bind the buttons with the corresponding callback function
        Btn0.bind('<ButtonPress-1>', call_forward)
        Btn1.bind('<ButtonPress-1>', call_back)
        Btn2.bind('<ButtonPress-1>', click_call_Right)
        Btn3.bind('<ButtonPress-1>', click_call_Left)
        Btn4.bind('<ButtonPress-1>', call_Stop)
        Btn5.bind('<ButtonPress-1>', call_auto)
        Btn6.bind('<ButtonPress-1>', call_look_right)
        Btn7.bind('<ButtonPress-1>', call_look_left)

        Btn8.bind('<ButtonPress-1>', call_look_up)
        Btn9.bind('<ButtonPress-1>', call_look_down)
